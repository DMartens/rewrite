...
## [3.0.0](https://github.com/DMartens/rewrite/compare/compat-v2.0.0...compat-v3.0.0) (2025-11-24)
...
* @eslint/compat package ([#5](https://github.com/DMartens/rewrite/issues/5)) ([e765f07](https://github.com/DMartens/rewrite/commit/e765f0764780144565aa51e56a097d1aaac8ddba))
...
* add eslint peer dependency ([#106](https://github.com/DMartens/rewrite/issues/106)) ([ae01ec3](https://github.com/DMartens/rewrite/commit/ae01ec385015724cb37020b0f50a2910dc032fa7))
* Add includeIgnoreFile() method ([#47](https://github.com/DMartens/rewrite/issues/47)) ([b5f74ed](https://github.com/DMartens/rewrite/commit/b5f74ed7bf20f287cc88579f2c6d9a27943d1105))
* add support for custom name parameter to `includeIgnoreFile` ([#211](https://github.com/DMartens/rewrite/issues/211)) ([3e18175](https://github.com/DMartens/rewrite/commit/3e1817535e75f6feca7aee6d9ec2afaa0f6ad859))
* patch missing context and SourceCode methods for v10 ([#311](https://github.com/DMartens/rewrite/issues/311)) ([a40d8c6](https://github.com/DMartens/rewrite/commit/a40d8c60af5bc09ea5e1c778655312a34ddc9f83))
...
* Escape `{` and `(` characters in `convertIgnorePatternToMinimatch` ([#79](https://github.com/DMartens/rewrite/issues/79)) ([811c3d7](https://github.com/DMartens/rewrite/commit/811c3d79de2588ca8aa10f6d9e8e706dae8986a4))
...
* relax `@eslint/compat` eslint peerDependencies constraint ([#215](https://github.com/DMartens/rewrite/issues/215)) ([b96ec0c](https://github.com/DMartens/rewrite/commit/b96ec0c2ed6006add49c9c83a599a7d5a284348e))
* Support legacy `schema` properties ([#128](https://github.com/DMartens/rewrite/issues/128)) ([3a87bbb](https://github.com/DMartens/rewrite/commit/3a87bbb7f0b501c74507f32083c289304d6c03a6))
...
* Upgrade @eslint/core ([#197](https://github.com/DMartens/rewrite/issues/197)) ([a830283](https://github.com/DMartens/rewrite/commit/a830283cd05a7a471aeec5f4589491f3c4092986))
* Upgrade ESLint to fix type errors ([#120](https://github.com/DMartens/rewrite/issues/120)) ([d0c879e](https://github.com/DMartens/rewrite/commit/d0c879e202f8b5f13a4334bffde6f22a9f80a195))
* Use types from @types/eslint ([#28](https://github.com/DMartens/rewrite/issues/28)) ([e94f435](https://github.com/DMartens/rewrite/commit/e94f4355c39cf4d566690fdc9180a97e06d292f1))
